...
1. Query NCBI
2. Query BOLD (best shot is my guess)
...
The NCBI database is way better than ITIS, and returns things in the correct scheme. 

## BOLD taxonomy

```{r, message=FALSE, warning=FALSE}
#taxreturn_s <- classification(species_list, db = 'bold')
